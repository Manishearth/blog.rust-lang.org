...
reducing the visual noise involved in error handling in Rust. It does this by
solving one simple problem. To illustrate, imagine we had some code to read some
data from a file:
